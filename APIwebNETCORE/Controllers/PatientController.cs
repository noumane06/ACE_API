...
namespace APIwebNETCORE.Controllers
{
    ...
    public class PatientController : ControllerBase
    {
        ...
        {
            return _documentClient.CreateDocumentQuery<Patient>(UriFactory.CreateDocumentCollectionUri(databseId, collectionId), new FeedOptions { MaxItemCount = 1 }).Where((i) => i.Num == id);
        }
        [HttpPost]
